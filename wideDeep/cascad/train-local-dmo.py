...
print(save_checkpoints_steps, "steps\n")
print("-------------------------------------\n")
#hdfs path
#training_data_pandas = '/ai_data/add.csv'
training_data_pandas = 'add.csv'
training_data_set = 'dmo:///data/add_dup.csv'
...
config = config.replace(keep_checkpoint_max=5, save_checkpoints_steps=save_checkpoints_steps)
